...
public class TestAccounts
{
    ...
    {
     InterestAccount in1 = new InterestAccount(1000, 0.25); 
     System.out.println("Interest Account in1 object's data after creation ");
     System.out.println(in1.toString());
     in1.addMonthlyInterest();
     System.out.println("Interest Account in1 object's data after adding interest (interest = 0.25)");
     System.out.println(in1.toString());
     System.out.println();

     System.out.println("Check InterestAccount in1 object's data");
     System.out.println(in1.toString());
     in1.setMonthlyInterestRate(0.1);
     in1.addMonthlyInterest();
     System.out.println("Interest Account in1 object's data after adding interest (0.1)");
     System.out.println(in1.toString());
     System.out.println();
